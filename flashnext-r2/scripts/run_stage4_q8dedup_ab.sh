...
BASELINE="${BASELINE:-qwen3.8-flash-next-r2-q8-off:256k}"
R2="${R2:-qwen3.8-flash-next-r2-q8-on:256k}"
OUT="${OUT:-/app/share/openclaw_tools/logs/flashnext-r2-q8-ab.json}"
